...

{
  config = {
    ...
    in {
      ...
      i_maildir-mbsync-notmuch = basics // { mbsync.enable = true; notmuch.enable = true; };
      j_maildir-notmuch = basics // { notmuch.enable = true; };
      j_maildir-offlineimap = basics // { offlineimap.enable = true; };
      j_maildir-offlineimap-notmuch = basics // { offlineimap.enable = true; notmuch.enable = true; };
